...
export const T = {
  en: {
    ...
    hero: {
      ...
      sub: "Maria answers calls, generates estimates, recovers missed leads, follows up on quotes, re-engages past customers, and manages your office via text — in English and Spanish, 24/7.",
      cta: "Get Capta",
    ...
    officeManager: {
      ...
      h2: "Text Maria. She knows your entire business.",
    ...
    features: {
      ...
      cards: [
        { title: "AI Estimates on the Call", desc: "Maria collects job details, generates a price range from your pricing, and texts it to you. Approve, adjust, or decline \u2014 the customer gets notified instantly." },
        { title: "60-Second Missed Call Recovery", desc: "Caller hangs up? Maria auto-texts them within 60 seconds. Your competitors never get the chance." },
        { title: "Automated Follow-Ups & Customer Recall", desc: "Cold estimates get automatic follow-ups. Past customers get re-engaged for seasonal work. Maria turns one-time callers into repeat revenue." },
        { title: "Partner Referral Network", desc: "Caller needs a trade you don\u2019t do? Maria refers them to your partner \u2014 and you get referrals back." },
      ],
  ...
  es: {
    ...
    hero: {
      ...
      sub: "Maria contesta llamadas, genera presupuestos, recupera leads perdidos, da seguimiento a cotizaciones, reactiva clientes anteriores y maneja tu oficina por texto \u2014 en ingl\u00E9s y espa\u00F1ol, 24/7.",
      cta: "Obt\u00E9n Capta",
    ...
    officeManager: {
      ...
      h2: "Env\u00EDale un texto a Maria. Ella conoce todo tu negocio.",
    ...
    features: {
      ...
      cards: [
        { title: "Presupuestos IA en la Llamada", desc: "Maria recopila detalles del trabajo, genera un rango de precio basado en tus precios, y te lo env\u00EDa por texto. Aprueba, ajusta o rechaza \u2014 el cliente es notificado al instante." },
        { title: "Recuperaci\u00F3n de Llamadas en 60 Segundos", desc: "\u00BFEl llamante colg\u00F3? Maria le env\u00EDa un texto autom\u00E1tico en 60 segundos. Tu competencia nunca tiene oportunidad." },
        { title: "Seguimientos Autom\u00E1ticos y Reactivaci\u00F3n", desc: "Los presupuestos fr\u00EDos reciben seguimiento autom\u00E1tico. Los clientes anteriores son reactivados para trabajo estacional. Maria convierte llamantes \u00FAnicos en ingresos recurrentes." },
        { title: "Red de Referidos entre Oficios", desc: "\u00BFEl llamante necesita un oficio que no haces? Maria lo refiere a tu socio \u2014 y t\u00FA recibes referidos de vuelta." },
      ],
