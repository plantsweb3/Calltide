...
## How Your AI Receptionist Handles a 200-Call Surge

She is the AI receptionist built into Capta. She does not get overwhelmed, does not need breaks, and does not put callers on hold. Here is what a storm day looks like with your receptionist answering your phones:
...
**Intelligent damage intake.** She asks the questions that matter for storm work: When did you notice the damage? Is water actively entering the home? What part of the roof is affected? Have you contacted your insurance company? She captures the details you need to triage and prioritize.
...
**Emergency escalation for active leaks.** Water coming through the ceiling at 2 AM gets flagged immediately. She texts you with the caller's name, address, phone number, and situation summary. You decide whether to tarp tonight or schedule for first light.

**Automatic inspection scheduling.** She books roof inspections directly into your calendar. The homeowner gets a confirmation text on the spot. When 50 people call in one afternoon, you end up with a structured inspection schedule instead of a pile of voicemails.

**Bilingual from the first word.** In Texas, Florida, Arizona, and California, a meaningful percentage of storm-damaged homeowners speak Spanish as their primary language. She handles those calls natively. No lost leads to language barriers during the most important week of your year.
...
**Conservative scenario:** One moderate hailstorm per year. She captures 50 additional leads you would have missed (out of the 128 from the table above).
...
**What about non-storm months?** She still answers every call during your normal weeks. The 5 to 10 routine calls per week that you miss while on a roof still add up. But the real value proposition for roofers is storm preparedness. Capta is insurance against the most expensive missed calls in your business.
...
**Capta:** Unlimited simultaneous calls. Flat rate. No per-minute charges. She handles 5 calls the same way she handles 500. The cost is the same whether it is a quiet Tuesday in January or the busiest storm day of the decade.
...
2. **Tell your receptionist about your roofing business.** Service area, job types (residential, commercial, storm damage, new construction), emergency protocols, and scheduling preferences.

3. **Forward your calls.** Route your business line to Capta. Most roofers forward all calls and let your receptionist handle everything, reviewing leads from their truck or at the end of the day.
...
## Tu Recepcionista AI: Tu Equipo de Respuesta a Tormentas

Ella es la recepcionista AI de Capta. Lo que la hace diferente para techadores no es que conteste llamadas (eso lo hace cualquier servicio de contestacion). Lo que la hace diferente es que fue disenada para oleadas.

Cuando caen 45 llamadas en 4 horas, Ella contesta las 45. Simultaneamente si es necesario. Sin poner a nadie en espera. Sin senal de ocupado. Sin buzon de voz.

Para cada llamada, tu recepcionista:
...
Ella maneja llamadas ilimitadas simultaneas a tarifa plana. No importa si son 5 o 500. El costo es el mismo.

## El ROI de Una Sola Tormenta

Capta cuesta $497/mes ($397/mes en plan anual, $4,764/ano).

Si Ella captura solo 50 llamadas adicionales de las 128 que habrias perdido en una tormenta moderada:
...
4. Espera la proxima tormenta. Cuando llegue, Ella captura cada llamada mientras tu te enfocas en inspecciones y reparaciones
...
## How Your AI Receptionist Manages Your Painting Pipeline

She is Capta's AI receptionist. But calling her a receptionist undersells what she does for painting contractors. She is more like a combination of a front desk, a sales coordinator, and a CRM in one system.

**Stage 1: Lead capture.** She answers every call in under 2 seconds, in English or Spanish. She asks the intake questions that matter for painting: interior or exterior? How many rooms? Any special considerations (lead paint, high ceilings, wallpaper removal, deck staining, cabinet refinishing)? She books the estimate appointment based on your availability. The homeowner gets a confirmation text immediately.
...
**Stage 3: The "how much does it cost?" problem.** Every painter gets this call. The homeowner wants a number before you even see the job. She handles it gracefully. She explains that pricing depends on the specific conditions (prep work, surface quality, ceiling height, number of coats) and that you provide free on-site estimates. She redirects toward booking the visit instead of quoting a number that will either scare the customer or lock you into a price you cannot hold.

**Stage 4: Follow-up that actually happens.** This is where your AI receptionist transforms a painting business. After the estimate is sent, She sends timed follow-up texts on your behalf:
...
These are not generic blasts. They reference the specific project because she captured the details during the initial call.

**Stage 5: Reactivation.** Leads that did not book after 30 days are not dead. They are just slow. She can re-engage them when a new season starts, when you have a gap in the schedule, or when you run a promotion. Those "dead" leads from spring become booked jobs in fall.

## The Pipeline Math

Let us compare two painting companies. Same market, same skills, same pricing. One has Capta. The other relies on voicemail and memory.
...
**Company B (with your receptionist):**
- Same 20 calls
- She answers all 20
- Books 16 estimates
- Sends 16 estimates, your receptionist follows up on all 16 systematically
...
She is built for that long game. She does not just answer the phone. She manages the entire journey from first call to signed contract. Intake. Estimate scheduling. Follow-up. Reactivation. Every step that most painters skip because they are busy doing the actual work.
...
Your AI receptionist makes sure that never happens again. She answers every call, books every estimate, follows up with every lead, and keeps your pipeline full so your crews stay busy through the slow months too.
...
## Como Tu Recepcionista AI Administra Tu Pipeline de Pintura

Ella es la recepcionista AI de Capta. Pero para pintores, es mas que una recepcionista. Es una combinacion de recepcion, coordinadora de ventas y CRM en un solo sistema.

**Captura de clientes.** Ella contesta cada llamada en menos de 2 segundos, en ingles o espanol. Hace las preguntas importantes: interior o exterior? Cuantas habitaciones? Consideraciones especiales (pintura con plomo, techos altos, remocion de papel tapiz, gabinetes, decks)? Agenda el presupuesto segun tu disponibilidad. El cliente recibe confirmacion por texto.

**La pregunta de "cuanto cuesta."** Ella maneja esto con profesionalismo. Explica que el precio depende de las condiciones especificas del trabajo y que ofreces presupuestos gratuitos en sitio. Redirige la conversacion hacia agendar la visita.

**Seguimiento que realmente sucede.** Aqui es donde tu recepcionista AI transforma un negocio de pintura. Despues de que mandas el presupuesto, ella envia textos de seguimiento programados:
...
No son mensajes genericos. Hacen referencia al proyecto especifico porque Ella capturo los detalles durante la llamada inicial.

**Reactivacion.** Los clientes que no agendaron despues de 30 dias no estan muertos. Solo son lentos. Ella puede re-contactarlos cuando empieza una nueva temporada o cuando tienes un hueco en el calendario.

## Las Matematicas del Pipeline

Comparemos dos empresas de pintura. Mismo mercado, mismas habilidades, mismos precios. Una tiene Capta. La otra depende del buzon de voz y la memoria.

**Sin Capta:** 20 llamadas/semana, contesta 10, agenda 8 presupuestos, cierra 25% (2 trabajos), $4,400/semana.

**Con Capta:** 20 llamadas/semana, contesta las 20, agenda 16 presupuestos, cierra 45% con seguimiento (7.2 trabajos), $15,840/semana.
...
Ella esta construida para ese juego largo. No solo contesta el telefono. Administra todo el camino desde la primera llamada hasta el contrato firmado. Captacion. Agendamiento de presupuestos. Seguimiento. Reactivacion. Cada paso que la mayoria de los pintores se salta porque estan ocupados haciendo el trabajo real.
...
La configuracion toma cinco minutos. Ingresa tu area de servicio, tipos de trabajo, disponibilidad para presupuestos y preferencias de seguimiento. Redirige tus llamadas. Ella empieza a construir tu pipeline de inmediato.
...
Ella se asegura de que eso no vuelva a pasar. Contesta cada llamada, agenda cada presupuesto, da seguimiento a cada cliente y mantiene tu pipeline lleno para que tus cuadrillas trabajen incluso en los meses lentos.
...
## How Your AI Receptionist Becomes Your Dispatch Center

She is Capta's AI receptionist, and for general contractors, she functions less like a receptionist and more like the operations manager you wish you could afford to hire.

**She sorts the signal from the noise.** When a call comes in, She determines the caller type and responds accordingly:
...
- **Existing client?** She captures their message, categorizes it (change order request, schedule question, concern, general update), and routes it to you with the appropriate urgency flag.
...
- **Supplier?** Details captured and logged. If it requires a decision (material substitution, delivery reschedule), She flags it so you see it before end of day.

**She protects your high-value time.** The 9:15 AM call from a homeowner asking about a $120,000 addition? Without Capta, that call gets your distracted, half-attention because you are in the middle of directing a crew. With Capta, that homeowner gets a calm, thorough intake process. Their project details are captured. A consultation is booked. You call them back at 4 PM with full context, full attention, and you close the deal.

**She prevents the cascading failure.** In general contracting, a missed call is rarely just a missed call. If you miss the inspector's rescheduling call, you do not find out until the sub shows up and there is no inspection. Now the sub's day is wasted. The project is delayed. The homeowner is frustrated. One missed call created a three-day delay and a thousand dollars in wasted labor. She prevents this by capturing and flagging every call, so nothing falls through.

**Bilingual by default.** In bilingual markets, She handles English and Spanish calls with native fluency. For GCs working in Texas, Florida, or California, this is not a bonus feature. It is the difference between serving your full market and losing every Spanish-speaking homeowner to a competitor who happens to have a bilingual office manager.
...
**New lead capture:** If your receptionist helps you capture just 2 additional projects per quarter that you would have lost to missed or distracted calls, that is $70,000 in additional revenue per quarter at $35,000 average project value.

**Operational efficiency:** If your receptionist's call triage prevents even one cascading scheduling failure per month (a missed inspection call that wastes a sub's day), that saves $500 to $1,500 in direct costs each time, plus the client relationship damage you cannot put a number on.

**Referral protection:** GCs live on referrals. A client whose calls always get answered and whose questions always get addressed promptly is a client who refers you to their neighbor. Your receptionist ensures every existing client interaction is handled professionally, protecting the referral pipeline that drives 40 to 60 percent of most GCs' new business.
...
She does not replace you. She gives you the operational backbone that lets you do what you are actually good at: running projects, managing crews, and building things that matter.
...
## Como Tu Recepcionista AI Se Convierte en Tu Centro de Despacho

Ella es la recepcionista AI de Capta. Para contratistas generales, funciona menos como recepcionista y mas como la gerente de operaciones que desearas poder contratar.

**Clasifica la senal del ruido.** Cuando entra una llamada, tu recepcionista determina el tipo de persona que llama y responde en consecuencia:
...
- **Cliente existente?** Ella captura su mensaje, lo categoriza (orden de cambio, pregunta de calendario, inquietud, actualizacion general) y te lo envia con la bandera de urgencia apropiada.
...
Si tu recepcionista te ayuda a capturar solo 2 proyectos adicionales por trimestre que habrias perdido, eso son $70,000 en ingresos adicionales por trimestre a $35,000 de valor promedio.

Si la clasificacion de llamadas de Ella previene incluso una falla de calendario en cascada al mes, eso ahorra $500 a $1,500 en costos directos cada vez.
...
Ella no te reemplaza. Te da la columna vertebral operacional que te permite hacer lo que realmente sabes hacer: dirigir proyectos, manejar cuadrillas, y construir cosas que importan.
...
## How Your AI Receptionist Scales With Your Seasons

She is Capta's AI receptionist. For pest control companies, her most important capability is not that she answers calls. It is that she scales.

In January, She answers your 8 calls per week. Cost: $497/month (or $397 on annual). Per-call cost: roughly $15.

In June, She answers your 50 calls per week. Cost: still $497/month. Per-call cost: roughly $2.50.

No hiring. No training. No seasonal temp who does not know the difference between carpenter ants and sugar ants. She handles 8 calls the same way she handles 200: instantly, professionally, and with pest-specific knowledge.
...
*Urgency classification.* Active wasp swarm near children? Immediate text alert to you. Routine ant prevention request? Booked for your next available slot. Rodent sounds in the walls at midnight? Flagged as urgent with a morning callback recommendation. She triages so you do not have to.

*Same-day booking for urgent calls.* When a panicked homeowner calls about wasps at 9 AM, She finds your first open afternoon slot and books it on the spot. Confirmation text goes out instantly.

*Maintenance plan seeding.* During every call, She naturally mentions that you offer ongoing pest prevention. She does not hard-sell. She plants the seed. "Many of our customers find that quarterly treatments prevent these issues from coming back. Would you like to hear about that when the technician visits?" This one feature alone can increase your maintenance contract sign-ups by 15 to 25 percent.

*Bilingual service.* In markets with significant Hispanic populations, She handles calls in Spanish natively. Pest emergencies are emotional. A parent calling in Spanish about a scorpion in the nursery needs to be heard and understood in their language. She does that.
...
**Option 4: Capta.** $497/month, flat, every month. 8 calls in January, 50 calls in June, 200 calls during an unexpected surge. Same cost. Same quality. 24/7. Bilingual. Pest-specific. No hiring. No training. No turnover.
...
She does not care if it is January or June. She answers every call, books every appointment, flags every emergency, and mentions every maintenance plan. When your busiest week of the year hits, she does not ask for overtime. When your slowest week hits, she does not cost you more than she is worth.
...
## Como Tu Recepcionista AI Escala Con Tus Temporadas

Ella es la recepcionista AI de Capta. Para empresas de control de plagas, su capacidad mas importante no es que contesta llamadas. Es que escala.

En enero, Ella contesta tus 8 llamadas por semana. Costo: $497/mes. Costo por llamada: aproximadamente $15.

En junio, Ella contesta tus 50 llamadas por semana. Costo: sigue siendo $497/mes. Costo por llamada: aproximadamente $2.50.
...
**Lo que Ella hace en cada llamada:**
...
*Agendamiento el mismo dia para llamadas urgentes.* Cuando un dueno de casa en panico llama por avispas a las 9 AM, tu recepcionista encuentra tu primer horario abierto de la tarde y lo agenda al instante.

*Mencion de planes de mantenimiento.* En cada llamada, Ella menciona naturalmente que ofreces prevencion continua. No vende agresivamente. Siembra la semilla. Esta sola funcion puede aumentar tus contratos de mantenimiento entre 15 y 25 por ciento.

*Servicio bilingue.* En mercados con poblaciones hispanohablantes significativas, Ella maneja llamadas en espanol de forma nativa. Las emergencias de plagas son emocionales. Un padre llamando en espanol por un alacran en el cuarto del bebe necesita ser escuchado y entendido en su idioma.
...
**Capta:** $497/mes, plano, todos los meses. 8 llamadas en enero, 50 en junio, 200 durante una oleada inesperada. Mismo costo. Misma calidad. 24/7. Bilingue. Especifica para plagas.

Capta cuesta $497/mes ($397/mes en plan anual, $4,764/ano). Sin contratos. Garantia de devolucion de 30 dias.

## Para Empezar

Entra a captahq.com/setup. Configura tu area de servicio, las plagas que tratas, tus protocolos de emergencia y tus preferencias de programacion. Redirige tu linea de negocio. Ella empieza a contestar de inmediato y va a escalar contigo desde los dias tranquilos de invierno hasta el caos de la temporada alta.
...
A Ella no le importa si es enero o junio. Contesta cada llamada, agenda cada cita, marca cada emergencia y menciona cada plan de mantenimiento. Cuando llega tu semana mas ocupada del ano, no pide horas extras. Cuando llega tu semana mas lenta, no te cuesta mas de lo que vale.
...
export const TRADES_B_PAIRS: [string, string][] = [
  ["ai-receptionist-for-roofers", "recepcionista-ai-para-techadores"],
  ["ai-receptionist-for-painters", "recepcionista-ai-para-pintores"],
  ["ai-receptionist-for-general-contractors", "recepcionista-ai-para-contratistas-generales"],
  ["ai-receptionist-for-pest-control", "recepcionista-ai-para-control-plagas"],
];
