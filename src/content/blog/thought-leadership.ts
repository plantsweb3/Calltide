...
export const THOUGHT_LEADERSHIP_PAIRS: [string, string][] = [
  ["future-phone-answering-service-businesses", "futuro-contestador-telefonico-negocios-servicios"],
  ["why-ai-wont-replace-contractors-replace-voicemail", "por-que-ai-no-reemplazara-contratistas-reemplazara-buzon"],
  ["how-ai-changing-america-home-repairs", "como-ai-cambiando-reparaciones-hogar-america"],
  ["small-business-ai-revolution-contractors", "revolucion-ai-pequenos-negocios-contratistas"],
  ["best-contractors-2026-never-touch-phone", "mejores-contratistas-2026-nunca-tocan-telefono"],
  ["economics-of-answering-every-call", "economia-contestar-cada-llamada"],
