...
export async function PUT(
  ...
  const rl = await rateLimit(`estimate-pricing-put:${businessId}`, RATE_LIMITS.write);
...
export async function DELETE(
  ...
  const rl = await rateLimit(`estimate-pricing-delete:${businessId}`, RATE_LIMITS.write);
  if (!rl.success) return rateLimitResponse(rl);
