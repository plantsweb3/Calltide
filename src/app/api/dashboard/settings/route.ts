...
export async function GET(req: NextRequest) {
  ...
  if (businessId === DEMO_BUSINESS_ID) {
    return NextResponse.json({
      ...
      greeting: "Thank you for calling Garcia Plumbing & HVAC, this is Maria. How can I help you today?",
      greetingEs: "Gracias por llamar a Garcia Plumbing & HVAC, habla Maria. ¿En qué le puedo ayudar?",
      defaultLanguage: "en",
...
export async function PUT(req: NextRequest) {
  ...
  const sanitized: Record<string, unknown> = {
    ...
    ...(data.voiceId !== undefined ? { elevenlabsVoiceId: data.voiceId || null } : {}),
  ...
  return NextResponse.json({
    ...
    voiceId: updated.elevenlabsVoiceId || "",
