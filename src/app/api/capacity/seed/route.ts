...
const playbook = [
  // SEED TIER
  { tier: "seed", clientRange: "1-50", provider: "elevenlabs", action: "Use Pro plan (10 concurrent, 1,200 min)", planRequired: "Pro", estimatedMonthlyCost: "$70", priority: "required" },
  ...
  // GROWTH TIER
  { tier: "growth", clientRange: "50-200", provider: "elevenlabs", action: "Upgrade to Scale plan (15 concurrent). Request limit increase if needed.", planRequired: "Scale", estimatedMonthlyCost: "$200-500", priority: "required" },
  ...
  // SCALE TIER
  { tier: "scale", clientRange: "200-500", provider: "elevenlabs", action: "Upgrade to Business plan (30 concurrent). Negotiate volume pricing.", planRequired: "Business", estimatedMonthlyCost: "$500-2,000", priority: "required" },
  ...
  // ENTERPRISE TIER
  { tier: "enterprise", clientRange: "500-1,000", provider: "elevenlabs", action: "Negotiate Enterprise plan. 100+ concurrent. SLA guarantees. Volume pricing.", planRequired: "Enterprise", estimatedMonthlyCost: "$3,000-5,000", priority: "required" },
  ...
  // HYPERGROWTH TIER
  { tier: "hypergrowth", clientRange: "1,000-2,000", provider: "elevenlabs", action: "Enterprise with 200+ concurrent. Dedicated infrastructure. Redundancy config.", planRequired: "Enterprise+", estimatedMonthlyCost: "$8,000-10,000+", priority: "required" },
