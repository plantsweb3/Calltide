...
const T = {
  en: {
    ...
    step1Sub: "Capta will answer calls, handle follow-ups, reviews, and scheduling automatically.",
    ...
    step2Sub: "Capta will text you updates and you can manage everything by texting back — dispatch, invoice, schedule, and more.",
    ownerName: "Your Name",
    ...
    step3Sub: "Name your receptionist and choose how Capta sounds on the phone.",
    namePresets: ["Maria", "Sofia", "Isabella", "Rachel", "Alex"],
    customName: "Custom Name",
    namePlaceholder: "Enter a name",
    personalityTitle: "Choose the personality",
    ...
    step5Title: "Capta already knows your trade",
    ...
    roiBreakeven: "Pays for itself after {count} answered calls",
    ...
    configSummary: "What Capta knows:",
    services: "services",
  ...
  es: {
    ...
    step1Sub: "Capta contestará llamadas, gestionará seguimientos, reseñas y agendamiento automáticamente.",
    ...
    step5Title: "Capta ya conoce tu industria",
    ...
    configSummary: "Lo que Capta sabe:",
    services: "servicios",
