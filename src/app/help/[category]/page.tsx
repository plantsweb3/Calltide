    ...
    <div className="min-h-screen" style={{ background: "#F8FAFC" }}>
      <div className="mx-auto max-w-5xl px-4 py-10">
        ...
        <nav className="flex items-center gap-1.5 text-sm" style={{ color: "#64748B" }}>
          ...
          <span className="font-medium" style={{ color: "#0F1729" }}>{cat.name}</span>
        </nav>
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-[1fr_260px]">
          ...
          <div>
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl font-bold tracking-tight" style={{ color: "#0F1729" }}>{cat.name}</h1>
              ...
              {articles.map((a) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="mt-2 text-xs" style={{ color: "#64748B" }}>{a.readingTimeMinutes} min read</p>
                  </div>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 rounded-xl border p-5 shadow-sm" style={{ borderColor: "#E2E8F0", background: "white" }}>
              <h3 className="text-xs font-bold uppercase tracking-[0.15em]" style={{ color: "#64748B" }}>Categories</h3>
