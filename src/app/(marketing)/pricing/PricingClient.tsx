...
const STRINGS = {
  en: {
    ...
    guaranteeSub: "If Capta doesn\u2019t pay for itself in missed-call revenue within 30 days, you pay nothing.",
    trustSecure: "Secure",
    trustCompliant: "Compliant",
    trust247: "24/7",
    faqTitle: "Frequently Asked Questions",
    finalTitle: "Stop missing calls. Start today.",
    finalGuarantee: "30-day money-back guarantee. Cancel anytime. No contracts.",
    featuresCol1: [
  ...
  es: {
    ...
    guaranteeSub: "Si Capta no se paga solo con ingresos de llamadas perdidas en 30 d\u00EDas, no pagas nada.",
    trustSecure: "Seguro",
    trustCompliant: "Cumplimiento",
    trust247: "24/7",
    faqTitle: "Preguntas Frecuentes",
    finalTitle: "Deja de perder llamadas. Empieza hoy.",
    finalGuarantee: "Garant\u00EDa de 30 d\u00EDas. Cancela cuando quieras. Sin contratos.",
    featuresCol1: [
