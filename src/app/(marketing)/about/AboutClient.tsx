...
const content = {
  en: {
    ...
    storyP3: "We built Calltide to fix that. An AI receptionist that answers every call in English and Spanish, books appointments, detects emergencies, and works 24/7 — for a fraction of the cost.",
  ...
  es: {
    ...
    storyP3: "Construimos Calltide para resolver eso. Una recepcionista IA que contesta cada llamada en inglés y español, agenda citas, detecta emergencias, y trabaja 24/7 — por una fracción del costo.",
