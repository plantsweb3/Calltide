...
const content = {
  en: {
    ...
    storyP3: "We built Capta to fix that. An AI that answers every call AND automates your entire front office — from dispatching to invoicing to follow-ups — all from your text messages. 24 AI tools via SMS, 48 background automations, zero busywork.",
    ...
    ctaSub: "AI receptionist + 24 SMS tools + 48 automations. Live in 5 minutes.",
  ...
  es: {
    ...
    storyP3: "Construimos Capta para resolver eso. Una IA que contesta cada llamada Y automatiza toda tu oficina — desde despacho hasta facturación y seguimientos — todo desde tus mensajes de texto. 24 herramientas IA por SMS, 48 automatizaciones, cero trabajo manual.",
    ...
    ctaSub: "Recepcionista IA + 24 herramientas SMS + 48 automatizaciones. En 5 minutos.",
