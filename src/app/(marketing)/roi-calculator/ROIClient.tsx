...
const T = {
  en: {
    ...
    missedAfterHours: "Calls missed by small businesses",
    missedAfterHoursDesc: "Small businesses miss 62% of incoming calls — evenings, weekends, lunches, and while on jobs.",
  ...
  es: {
    ...
    missedAfterHours: "Llamadas perdidas por pequeños negocios",
    missedAfterHoursDesc: "Las pequeñas empresas pierden el 62% de las llamadas entrantes — noches, fines de semana, horas de almuerzo y mientras trabajan.",
