...
const T = {
  en: {
    ...
    // Step 3
    step3Title: "Choose the Style",
    step3Sub: "How should Capta sound on the phone?",
    ...
    // Step 4
    step4Title: "Teach Capta Your Business",
    step4Sub: "Help Capta answer common questions and stay on-brand.",
    faqLabel: "Common Questions",
    faqSub: "When callers ask these, Capta will use your answers.",
    ...
    offLimitsSub: "Capta will politely redirect if callers ask about these.",
    ...
    phrasesSub: "Words or phrases Capta should weave into conversations.",
    phrasesPlaceholder: "e.g. \"We offer a satisfaction guarantee\"\n\"Same-day service available\"",
    // Step 5
    step5Title: "Interview",
    step5Sub: "Call now and see how Capta handles a real conversation.",
    callNow: "Call now:",
    tapToCall: "Tap to call",
    waiting: "Waiting for your call...",
    connected: "Call connected! Capta is answering...",
    ...
    knowsYourBusiness: "Capta knows your hours, services, and emergency protocol",
    skipTest: "Skip for now",
    skipNudge: "We recommend interviewing before Capta goes live — it takes 2 minutes!",
    // Step 6 - Paywall
    step6Title: "Activate",
    ...
    testVerify: "Call your business number now to verify Capta answers",
