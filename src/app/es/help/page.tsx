    ...
    <div className="min-h-screen" style={{ background: "#F8FAFC" }}>
      ...
      <section className="relative overflow-hidden py-20 md:py-28" style={{ background: "#111827" }}>
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center">
          <p className="text-xs font-semibold uppercase tracking-[0.2em]" style={{ color: "#D4A843" }}>Centro de Ayuda</p>
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {categories.map((cat) => (
              ...
              >
                ...
                <h3 className="mt-3 font-semibold" style={{ color: "#0F1729" }}>{cat.nameEs || cat.name}</h3>
