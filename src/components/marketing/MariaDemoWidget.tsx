...
const LABELS = {
  en: {
    ...
    endedCalls: "calls",
    endedCta: "Start Your Free Trial",
    endedCtaSub: "Maria will be live in 5 minutes",
    endedRetry: "Talk to Maria again",
    micNote: "Uses your browser microphone",
    elapsed: "Elapsed",
    errorBusy: "Maria's busy right now. Sign up for a free trial to talk to her anytime.",
  ...
  es: {
    ...
    endedCalls: "llamadas",
    endedCta: "Comienza Tu Prueba Gratis",
    endedCtaSub: "Maria estará activa en 5 minutos",
    endedRetry: "Habla con Maria de nuevo",
    micNote: "Usa el micrófono de tu navegador",
    elapsed: "Tiempo",
    errorBusy: "Maria está ocupada ahora. Regístrate para una prueba gratis y habla con ella cuando quieras.",
