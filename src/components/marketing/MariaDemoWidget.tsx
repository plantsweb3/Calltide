...
const LABELS = {
  ...
  es: {
    ...
    elapsed: "Tiempo",
    errorBusy: "Está ocupada ahora. Comienza tu prueba gratis para hablar con ella cuando quieras.",
