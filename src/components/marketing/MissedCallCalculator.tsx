...
export function MissedCallCalculator({ lang }: Props) {
  ...
  const t = lang === "es" ? {
    ...
    emailHeading: "Recibe tu informe personalizado",
    emailSub: "Te enviaremos un desglose con comparaciones de la industria y una estrategia para recuperar esos ingresos.",
    emailPlaceholder: "tu@email.com",
    send: "Enviar Mi Informe",
    sending: "Enviando...",
    thanks: "Revisa tu email",
    thanksSub: "Tu informe personalizado está en camino.",
    ...
    emailHeading: "Get your personalized report",
    emailSub: "We'll send you a breakdown with industry benchmarks and a strategy to recover that revenue.",
    emailPlaceholder: "you@email.com",
    send: "Send My Report",
    sending: "Sending...",
    thanks: "Check your inbox",
    thanksSub: "Your personalized report is on the way.",
